...
34. Each registry operation, applyChanges, resetSecret, listServers, previewReplan and whosOnline.list included, with access control forced to error → Denied; nothing changed; no audit entry.
